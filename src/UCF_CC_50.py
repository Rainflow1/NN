...
class UCF_CC_50_Dataset:
    ...
    def __getitem__(self, i):
        ...
        match i:
            case 'test':
                return CCDataset("./temp/dataset/UCF_CC_50/test", self.rng)
            case 'train':
                return CCDataset("./temp/dataset/UCF_CC_50/train", self.rng)
            case 'valid':
                return CCDataset("./temp/dataset/UCF_CC_50/valid", self.rng)
            case _:
                return CCDataset("./temp/dataset/UCF_CC_50/train", self.rng)
